            ...
            <form  role="form" action="<?= $action ?>" method="post">
                <div class="col-md-6">
                    <label>Área Técnica</label> 
                     <input id="nome_area_tecnica" name="nome_area_tecnica" placeholder="Nome área técnica" 
                     class="form-control input-md" required="" value="<?= $area_tecnica['nome_area_tecnica'] ?>" type="text">
                </div>
                <br/>
                <div class="col-md-6">
